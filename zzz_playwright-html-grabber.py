# to run nicegui documentation website:
# pip install itsdangerous prometheus_client isort docutils pandas plotly pyecharts matplotlib requests dnspython
# ... not sure all of those pip's are required, but it works:
# cd /Users/cleesmith/nicegui
# conda activate nicegui (python=3.10)
# python -B main.py
...
# python -B zzz_get_nicegui_docs_urls.py
# Total crawling time: 22.62 seconds
# Total URLs found: 104
# "http://localhost:8080/documentation/section_text_elements",
# "http://localhost:8080/documentation/section_controls",
# "http://localhost:8080/documentation/section_audiovisual_elements",
# "http://localhost:8080/documentation/section_data_elements",
